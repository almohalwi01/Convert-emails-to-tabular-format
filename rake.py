...
debug = False
test = False
stop_words_path ='/Users/ashrafmahlawi/NLP_Project/emails_datasetNEW/*'
def is_number(s):
    try:
...
def build_stop_word_regex(stop_words_path):
    stop_word_list = load_stop_words(stop_words_path)
